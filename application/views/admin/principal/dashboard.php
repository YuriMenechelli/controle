...
<section class="content">
	...
	<div class="row">
		...
		<!--<div class="col-md-6">
			<div class="box">
				<div class="box-header with-border">
					<h3 class="text-center"><i class="fa fa-users"></i> Ultimos clientes cadastrados</h3>
				</div>
				<div class="box-body">
					<table class="table table-striped table_list_data">
						<thead>
						...
						<?php /*foreach ($clientes as $cliente): */?>
							<tr>
								<td class="text-center"><?/*= formatDateView($cliente->dt_cadastro) */?></td>
								<td><?/*= $cliente->nome */?></td>
								<td class="text-center"><?/*= ($cliente->ativo == 1 ? '<span class="label label-success">Ativo</span>' : '<span class="label label-danger">Inativo</span>') */?></td>
							</tr>
						<?php /*endforeach; */?>
						</tbody>
					</table>
				...
				<div class="box-footer text-right">
					<a href="<?/*= base_url('admin/clientes')*/?>" class="label label-primary  small-box-footer">Mais informações <i class="fa fa-arrow-circle-right"></i></a>
				</div>
			</div>
		</div>-->
	</div>
